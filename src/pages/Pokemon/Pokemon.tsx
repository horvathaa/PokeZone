            ...
            <section className="Pokemon">
                ...
                >
                    ...
                    <div className="caja-descripcion">
                        ...
                        <p className="descripcion__biografia">
                            {pokemon.descripcion}
                        </p>
                    </div>
                    <img
